...
const (
	addPodNameLabelAnnotation = "markus.de/add-pod-name-label"
	podNameLabel              = "markus.de/pod-name"
)
...
func (r *PodReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &pod); err != nil {
		if apierrors.IsNotFound(err) {
			// we will ignore not-found errors since we can get them on deleted requests
